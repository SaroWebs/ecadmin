...
class CustomerLoginController extends Controller
{
    ...
    public function verifyOTP(Request $request)
    {
        $request->validate([
            ...
            'name' => 'required_if:isNewUser,true|string|max:255',
            'email' => 'required_if:isNewUser,true|email|max:255',
        ]);
        ...
        if (!$customerLogin || $customerLogin->otp !== $request->otp || $customerLogin->otp_expired_at < now()) {
